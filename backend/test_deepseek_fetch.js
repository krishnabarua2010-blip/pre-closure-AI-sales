...
async function testLeadScoring() {
  console.log("🚀 Calling DeepSeek v4 Pro for Lead Scoring...");
  try {
...
async function testAdvisorCommands() {
  console.log("\n🚀 Testing AI Advisor Mode via DeepSeek v4 Pro (sequentially with 5s delay)...");
  const queries = [
    "What happened today?",
...
async function run() {
  ...
  console.log("\n⏳ Sleeping for 15s to avoid rate limits...");
  await sleep(15000);
