...
const apollo_service_1 = require("../external/apollo.service");
...
class DiscoveryService {
    static async discoverAndScorePipeline(businessProfileId, niche, location, count = 10) {
        ...
        const rawLeads = await apollo_service_1.ApolloService.searchLeads(niche, location, count);
        const bpContext = {
            ...
            try {
                ...
                const updatedLead = await prisma_1.prisma.lead.update({
                    ...
                    data: {
                        ...
                        behavioral_signals: { "pain_points": enriched.insights?.pain_points, "desires": enriched.insights?.desires }
                    }
                });
                // Upsert Outreach
                ...
                if (existingOutreach) {
                    await prisma_1.prisma.outreach.update({
    ...
    static async runSuperPrompt(leadObj, bpCtx) {
