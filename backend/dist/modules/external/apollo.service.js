...
class ApolloService {
     ...
     */
    static async searchLeads(niche, location, limit = 10) {
        ...
        try {
            const response = await axios_1.default.post(`${APOLLO_BASE_URL}/mixed_companies/search`, {
    ...
    static mockScrape(niche, location, count) {
        const leads = [];
